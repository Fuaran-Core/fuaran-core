...
- **`RowIdentity<'Id>`** (`{ Scheme; KeyOf; KeyString }`, `0.7.0`) — the columnar strand's
...
## Column-layer deltas (Phase 98, `0.7.0`)
...
**`DataFrame.cellToken` / `rowToken` / `rowTokenString`** are public as of `0.7.0` — the pinned
