...
and enc_vkind (#num #flt: eqtype) (x: vkind num flt) : Tot (jval num flt) (decreases x) =
  ...
  | C__vkind__Score f0 f1 f2 ->
    JObj (("kind", JStr "Score") :: ("children", JArr (enc_items_l_node f0)) :: (match f1 with | None -> (match f2 with | None -> [] | Some w -> ("title", JStr w) :: []) | Some w -> ("composer", JStr w) :: (match f2 with | None -> [] | Some w -> ("title", JStr w) :: [])))
  ...
  | C__vkind__Measure f0 f1 f2 f3 f4 f5 ->
    JObj (("kind", JStr "Measure") :: ("children", JArr (enc_items_l_node f0)) :: (if f1 = false then ("number", JInt f2) :: (if f3 = false then (if f4 = false then (match f5 with | None -> [] | Some w -> ("volta", JArr (enc_items_l_int w)) :: []) else ("repeatStart", JBool f4) :: (match f5 with | None -> [] | Some w -> ("volta", JArr (enc_items_l_int w)) :: [])) else ("repeatEnd", JBool f3) :: (if f4 = false then (match f5 with | None -> [] | Some w -> ("volta", JArr (enc_items_l_int w)) :: []) else ("repeatStart", JBool f4) :: (match f5 with | None -> [] | Some w -> ("volta", JArr (enc_items_l_int w)) :: []))) else ("isAnacrusis", JBool f1) :: ("number", JInt f2) :: (if f3 = false then (if f4 = false then (match f5 with | None -> [] | Some w -> ("volta", JArr (enc_items_l_int w)) :: []) else ("repeatStart", JBool f4) :: (match f5 with | None -> [] | Some w -> ("volta", JArr (enc_items_l_int w)) :: [])) else ("repeatEnd", JBool f3) :: (if f4 = false then (match f5 with | None -> [] | Some w -> ("volta", JArr (enc_items_l_int w)) :: []) else ("repeatStart", JBool f4) :: (match f5 with | None -> [] | Some w -> ("volta", JArr (enc_items_l_int w)) :: [])))))
